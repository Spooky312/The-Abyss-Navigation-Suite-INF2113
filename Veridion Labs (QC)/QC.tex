...
\begin{itemize}[leftmargin=*]
\item SRS (Smart Contract Enabled Pharmaceutical Supply Chain System, 6 March 2026)
\item Project Specification (background)
\item Requirements models (context, sequence, architecture diagrams)
\item Codification and iRTM sections
\item Quality model and change mitigation sections
\item Appendices and traceability artefacts
\end{itemize}
...
The \textbf{Software Requirements Specification (SRS)} for the Smart Contract Enabled Pharmaceutical Supply Chain System.

\subsection{Context and Goals}
The SRS is the baseline for downstream development. This audit verifies its clarity, completeness, and consistency, documenting defects for customer action.

\subsection{Access and Audit Conditions}
The QC team reviewed the released SRS and supporting artefacts provided for audit.

\subsection{Inspection Techniques Used}
\begin{enumerate}[leftmargin=*]
\item Close document inspection
\item Perspective-based reading (developer, tester, PM, compliance)
...
\item Scenario-based reading (supply-chain scenarios)
\item Assumption reading
\item Double-checking dates, facts, figures
