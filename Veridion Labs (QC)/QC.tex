...
\hline
\end{tabular}
\caption{Table 1: Veridion Labs QC Audit Team}
\label{tab:qc-team}
\end{table}
...
The SRS specifies extensive biometric scanning behaviour but is entirely silent on the student fingerprint enrolment process -- a prerequisite capability without which the attendance system cannot function. See \hyperref[tab:qc-findings-summary]{Appendix D, Table D-1: QC Findings Summary} for the finding summary entry. \\
...
\hline
\end{tabular}
\caption{Table 2: QC Audit Team Sign-Off}
