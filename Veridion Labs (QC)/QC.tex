...
\caption{Table B-1: QC Inspection Checklist}\label{tab:qc-checklist}\\
\hline
\rowcolor{tableheader}
...
\caption{Table C-1: Detected QC Error Instances}\label{tab:qc-error-detection}\\
\hline
\rowcolor{tableheader}
...
\caption{Table D-1: QC Findings Summary}\label{tab:qc-findings-summary}\\
\hline
\rowcolor{tableheader}
