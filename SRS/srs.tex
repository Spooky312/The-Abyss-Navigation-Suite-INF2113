...
\hline
Customer (Triton Deepwater) & Project Leader / Requirements Approver & Sarah Whitman & \makebox[\linewidth][c]{\includegraphics[height=1.2cm]{../Signatures/sarah_whitman.png}} \\
\hline
Customer (Triton Deepwater) & Safety \& Compliance Approver & Emily Carter & \makebox[\linewidth][c]{\includegraphics[height=1.2cm]{../Signatures/emily_carter.png}} \\
\hline
Vendor (Brigman Deep Sea Technology) & Engineering Delivery Lead & Nathan Briggs & \makebox[\linewidth][c]{\textit{Signature pending}} \\
\hline
Vendor (Brigman Deep Sea Technology) & Verification \& Validation Lead & Olivia Reyes & \makebox[\linewidth][c]{\textit{Signature pending}} \\
\hline
\end{tabular}
