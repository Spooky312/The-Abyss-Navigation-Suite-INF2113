...
\hline
SEC-ACC-001 & Essential & Vendor Provision & QUAL-SEC-001, QUAL-TRC-001 & The system shall enforce role-based access control (RBAC) such that each defined user role is granted only the permissions required for its operational scope. & Test: Attempt unauthorised actions per role; confirm access denial. & --- \\
\hline
SEC-2FA-001 & Desirable & Vendor Provision & QUAL-SEC-001 & The system shall support configurable two-factor authentication policies, including mandatory 2FA for administrative roles. & Test: Enable policy; confirm 2FA enforcement during login for administrative roles. & --- \\
\hline
SEC-SES-001 & Desirable & Vendor Provision & QUAL-SEC-001 & The system shall enforce configurable session timeout values and automatically terminate inactive sessions after the configured duration. & Test: Configure timeout; confirm automatic session termination after inactivity. & --- \\
\hline
...
\subsection{6.1 Alignment with McCall Quality Model}
...
\subsection{6.2 BDST Quality Features}
...
Additional Project Specification models (e.g., organisation chart and roles/responsibilities) are either explicitly included within this SRS or incorporated via controlled cross-reference to the Project Specification appendices. No requirement-relevant model exists outside the trace-controlled SRS baseline; all cross-referenced models are version-controlled within the same project repository.
...
\hline
Muhammad Ridwan Putra Jasni & BDST-RE-BA-001 & \makebox[\linewidth][c]{\includegraphics[height=1.2cm]{../Signatures/signature_ridwan.jpg}} \\
\hline
Chng Zong Han & BDST-RE-BA-002 & \makebox[\linewidth][c]{\includegraphics[height=1.2cm]{../Signatures/signature_zonghan.jpg}} \\
\hline
Lin Yuhao & BDST-RE-BA-003 & \makebox[\linewidth][c]{\includegraphics[height=1.2cm]{../Signatures/signature_yuhao.jpg}} \\
\hline
Muhammad Mikhail Bin Mazlan & BDST-RE-BA-004 & \makebox[\linewidth][c]{\includegraphics[height=1.2cm]{../Signatures/signature_mikhail.jpg}} \\
\hline
Kannan s/o Rajamohan & BDST-RE-BA-005 & \makebox[\linewidth][c]{\includegraphics[height=1.2cm]{../Signatures/signature_kannan.jpg}} \\
\hline
\end{tabular}
...
\hline
Customer (Triton Deepwater) & Project Leader / Requirements Approver & Role Holder \\
\hline
Customer (Triton Deepwater) & Safety \& Compliance Approver & Role Holder \\
\hline
Vendor (Brigman Deep Sea Technology) & Engineering Delivery Lead & Role Holder \\
\hline
Vendor (Brigman Deep Sea Technology) & Verification \& Validation Lead & Role Holder \\
\hline
\end{tabular}
\caption{Designated approvers (role-based; named individuals to be recorded in formal approval transmittal)}
\label{tab:designated-approvers}
\end{table}

\smallskip
\noindent\textit{The designated organisational role holder at the time of SRS baseline approval shall assume approval authority. Named individuals may be recorded in the formal approval record or transmittal documentation. The SRS remains role-based to preserve governance continuity across personnel changes.}
...
\begin{figure}[H]
\centering
\orighyperref[tab:response-sequence]{\includegraphics[width=0.95\textwidth]{../Models/Use Case Diagram.pdf}}
