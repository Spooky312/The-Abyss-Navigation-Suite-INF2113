...
\small
\renewcommand{\arraystretch}{1.4}
\begin{tabularx}{\textwidth}{|p{0.15\textwidth}|p{0.18\textwidth}|p{0.2\textwidth}|X|}
\hline
\rowcolor{tableheader}
\textbf{Error ID} & \textbf{Error Type} & \textbf{Location} & \textbf{Characteristic of Error} \\
\hline
QC-ERR-001 & Authorship & Section 4.2, Communications \& Remote Operations & Wording of remote intervention timing can be interpreted differently depending on operator and link conditions. \\
\hline
QC-ERR-002 & Contradiction & Sections 4.1 and 4.2 & Autonomous mission execution is emphasized, while other passages imply supervisory or intervention behaviour that may conflict with autonomy precedence. \\
\hline
QC-ERR-003 & Omission & Section 4.3, Safety \& Recovery & Some exception and boundary-condition handling is not specified to the same detail as normal operational behaviour. \\
\hline
QC-ERR-004 & Omission & Sections 7 and 9 / supporting models & Some traceability and model-link coverage can be made clearer for downstream auditability. \\
\hline
QC-ERR-005 & Authorship & Section headings / cross-references & Minor inconsistencies in naming and presentation patterns reduce uniform readability. \\
\hline
\end{tabularx}
\caption{Detected QC error instances}
