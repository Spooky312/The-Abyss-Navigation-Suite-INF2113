...
\item \textbf{Appendix B: Risk Assessment Matrix Legend} \dotfill B-1
\end{itemize}
...
Our systematic risk assessment evaluates potential challenges using a risk matrix (Table~\ref{tab:risk-legend}) rated 1-8 for impact and likelihood. Figure~\ref{fig:risk-assessment} details all identified risks with corresponding mitigation strategies.
...
\textbf{R4: Technical Knowledge Asymmetry.} Triton's deep-sea expertise does not extend to software evaluation, risking costly misalignment discovered late in development. \textit{Mitigation:} Hands-on workshops using familiar mission scenarios and early prototypes to facilitate tangible requirement discussions.

\textbf{R5: Institutional Knowledge Loss.} Critical operational knowledge resides with experienced personnel, not documentation. Recent restructuring increases departure risk, threatening irreplaceable expertise in emergency procedures and safety judgement. \textit{Mitigation:} Comprehensive decision logs capturing rationale and cultivating backup contacts to eliminate single points of failure.

\textbf{R7: Withheld Critical Specifications.} Security concerns may prevent disclosure of platform and environmental specifications despite NDAs, forcing design assumptions that risk integration failures. \textit{Mitigation:} Negotiate phased tiered disclosure under NDA, and formally log all assumptions with customer sign-off to ensure shared accountability.
