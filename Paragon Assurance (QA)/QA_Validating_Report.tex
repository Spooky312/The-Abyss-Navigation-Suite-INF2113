...
\AddToShipoutPictureBG*{%
  \AtPageLowerLeft{%
    \includegraphics[width=\paperwidth,height=\paperheight]{template/Paragon_Letterhead.pdf}%
  }%
}

\begin{center}
\includegraphics[width=0.45\textwidth]{template/paragon_assurance_logo.jpg}\\[0.8cm]
...
\begin{itemize}
    ...
    \item The biometric student enrolment process is a prerequisite for all scan-based functions which was not elicited and is absent from the SRS (PA-ERR-004).
...
The checklist addresses process compliance across four domains using three investigation methods: \textbf{M1} (Artefact Inspection), \textbf{M2} (Traceability and Cross-Reference), and \textbf{M3} (Declaration and Sign-Off Review). \\Rating key:\\\textbf{S} = Satisfied\\\textbf{PS} = Partially Satisfied\\\textbf{NS} = Not Satisfied\\\textbf{N/A} = Not Applicable.\\Full checklist with detailed notes is in Appendix~\ref{app:checklist}.
...
PA-ERR-004 & SRS \S4; AR \S3.3--3.4; repository & Biometric enrolment; prerequisite for scan-based operations was not elicited. No requirement exists despite BOR-0-03 referencing it. \\\hline
...
\noindent\textbf{Error:} PA-ERR-001 \quad \textbf{Severity:} High \quad \textbf{Phase:} Analysing \& Specifying 
...
\subsection{PA-FND-002: SRS Sign-off Entirely Absent}

\noindent\textbf{Evidence:} See \ref{ann:evidence-002} (Annex)

\noindent\textbf{Error:} PA-ERR-002 \quad \textbf{Severity:} Critical \quad \textbf{Phase:} Validating
...
\noindent\textbf{Error:} PA-ERR-003 \quad \textbf{Severity:} High-to-Medium \quad \textbf{Phase:} Analysing \& Specifying
...
\noindent\textbf{Error:} PA-ERR-004 \quad \textbf{Severity:} High-to-Medium \quad \textbf{Phase:} Analysing \& Specifying
...
\noindent\textbf{Error:} PA-ERR-005 \quad \textbf{Severity:} High-to-Medium \quad \textbf{Phase:} Specifying
...
\noindent\textbf{Error:} PA-ERR-006 \quad \textbf{Severity:} Medium \quad \textbf{Phase:} Specifying
